        ...
        <div class="form flex flex-col flex-start my-4">
          <div class="flex my-8 gap-4">
            <div class="w-full flex flex-col gap-2 text-white">
              ...
              <InputText
                id="name"
                class="mb-2 bg-background border-slate-700" v-model="employeeStore.selectedEmployee.full_name" />
            </div>
            <div class="w-full flex flex-col gap-2 text-white">
              <label for="email">E-mail</label>
              <InputText
                id="email"
                class="mb-2 bg-background border-slate-700" v-model="employeeStore.selectedEmployee.email" />
            </div>
          </div>
